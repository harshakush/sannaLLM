...
def main():
    ...
    patience = 8  # Increased from 2 to 8
    min_epochs = 5  # Force at least 5 epochs before early stopping
    improvement_threshold = 1e-4  # Minimum improvement to consider as progress
    ...
    if mode == "train":
        ...
        # FIXED: Learning rate scheduler without verbose parameter
        ...
        # 5. Enhanced training loop with improved early stopping
        ...
        for epoch in range(num_epochs):
            ...
            # Manual verbose output for scheduler
        ...
        # 6. Save vocabulary and enhanced training log
        ...
        # 8. Enhanced generation function
        ...
        # 9. Auto-generate sample text with different strategies
        print(f"\n{'='*60}")
        ...
        # 10. Enhanced interactive generation
        print(f"\n{'='*60}")
    ...
    # === RESUME TRAINING IMPLEMENTATION ===
        ...
        # Continue with data loading and training...
